...
public class XCItemSPDagger extends Item
{
    private float weaponDamage;
    private final XCEnumToolMaterial toolMaterial;

    public XCItemSPDagger(int var1, XCEnumToolMaterial var2)
    {
        super(var1);
        this.toolMaterial = var2;
        this.maxStackSize = 2;

        if (this.toolMaterial == XCEnumToolMaterial.BONE)
        {
            this.setMaxDamage(var2.getMaxUses());
            this.weaponDamage = 2.0F + var2.getDamageVsEntity();
        }
        else
        {
            this.setMaxDamage(var2.getMaxUses() / 2);
            this.weaponDamage = (2.0F + var2.getDamageVsEntity()) / 2;
        }
    }
