...
public class XCEntityAIArcherLookAtVillager extends EntityAIBase
{
    private XCEntityVillageArcher field_48406_a;
    private EntityVillager field_48404_b;
    private int field_48405_c;

    public XCEntityAIArcherLookAtVillager(XCEntityVillageArcher var1)
    {
        this.field_48406_a = var1;
        this.setMutexBits(3);
    }
