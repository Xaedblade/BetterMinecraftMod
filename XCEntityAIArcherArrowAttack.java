...
public class XCEntityAIArcherArrowAttack extends EntityAIBase
{
    World worldObj;
    ...
    public XCEntityAIArcherArrowAttack(EntityLiving var1, float var2, int var3, int var4)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        if (var1 != null && var1.getClass() != XCEntityVillageSoldier.class && var1.getClass() != XCEntityIronGolem.class && var1.getClass() != XCEntityVillageArcher.class)
        {
