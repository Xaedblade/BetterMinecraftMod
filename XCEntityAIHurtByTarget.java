...
public class XCEntityAIHurtByTarget extends EntityAITarget
{
    boolean field_75312_a;
    EntityLiving field_75311_b;

    public XCEntityAIHurtByTarget(EntityLiving var1, boolean var2)
    {
    ...
    public void startExecuting()
    {
        ...
        if (this.field_75312_a && this.taskOwner.getAITarget().getClass() != EntityVillageArcher.class)
        {
